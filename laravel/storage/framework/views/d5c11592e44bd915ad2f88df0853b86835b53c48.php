<?php $__env->startSection('title'); ?>
     Admin area: <?php echo e(trans('sample::service_admin.page_list')); ?>
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin"><i class="fa fa-group"></i> <?php echo $request->all() ? trans('sample::service_admin.page_search') : trans('sample::service_admin.page_list'); ?></h3>
                </div>
                <div class="panel-body">
                    <?php echo $__env->make('sample::service.admin.service_item', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
               </div>
           </div>
        </div>
        <div class="col-md-4">
